import lemon from "@/public/neon-shinjuku/1symb.webp";
import cherries from "@/public/neon-shinjuku/2symb.webp";
import orange from "@/public/neon-shinjuku/3symb.webp";
import bell from "@/public/neon-shinjuku/4symb.webp";
import diamond from "@/public/neon-shinjuku/5symb.webp";
...
export const SOUND_PATHS = {
  background: "../../neon-shinjuku/sounds/bg.mp3",
  spin: '../../neon-shinjuku/sounds/spin.mp3',
  symbols: {
    lemon: '../../neon-shinjuku/sounds/1symb.mp3',
    cherries: '../../neon-shinjuku/sounds/2symb.mp3',
    orange: '../../neon-shinjuku/sounds/3symb.mp3',
    bell: '../../neon-shinjuku/sounds/4symb.mp3',
    diamond: '../../neon-shinjuku/sounds/5symb.mp3',
  }
};
