import lemon from "@/public/maestro/1symb.webp";
import cherries from "@/public/maestro/2symb.webp";
import orange from "@/public/maestro/3symb.webp";
import bell from "@/public/maestro/4symb.webp";
import diamond from "@/public/maestro/5symb.webp";
...
export const SOUND_PATHS = {
  background: "../../maestro/sounds/bg.mp3",
  spin: '../../maestro/sounds/spin.mp3',
  symbols: {
    lemon: '../../maestro/sounds/1symb.mp3',
    cherries: '../../maestro/sounds/2symb.mp3',
    orange: '../../maestro/sounds/3symb.mp3',
    bell: '../../maestro/sounds/4symb.mp3',
    diamond: '../../maestro/sounds/5symb.mp3',
  }
};
